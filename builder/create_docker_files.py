...
if __name__ == '__main__':
    ROS_DISTROS: dict[str, str] = {'noetic': '20.04'}

    def create_items_to_install(
        base_img: str, image_main_user: str, ros_distro: str, img_id_to_build: str, use_host_nvidia_driver: bool
    ...
    parser.add_argument('image_main_user', type=str, help='User to run containers for the resulting Docker image')
    ...
    if not base_img:
        ...
        print(f"No base image specified, defaulting to '{base_img}' for 'ROS2-{ros_distro}'")
    ...
    install_items(
        create_items_to_install(base_img, image_main_user, ros_distro, img_id_to_build, args.use_host_nvidia_driver),
        context_dir,
    )
